...
public class RejoinTable implements Table {
    ...
    public class RejoinColumn implements Column {
        ...
        public String getColumnNameSQL() {
            return _column.getColumnNameSQL();
        }

        public String getTypeNameSQL() {
            return _column.getTypeNameSQL();
        }

        public Integer getTypeLength() {
            return _column.getTypeLength();
        }

        public List<?> getTypeQualifiers() {
            return _column.getTypeQualifiers();
        }

        public List<? extends Constraint> getConstraints() {
            return _column.getConstraints();
        }

        public Object getDefaultValue() {
            return _column.getDefaultValue();
        }
